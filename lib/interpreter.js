...
//const { getVar, setVar } = require("./identifier");
...
function interpretProgram() {
            ...
            if (tokens[0] == "I") {
                ...
                if (tokens[3] == "ITZ A") {
                    ...
                    switch(tokens[4]) {
                        ...
                        case "TROOF":
                        global.vars[0][name]=new Troof();
                        return;
                        
                        case "NUMBR":
                        global.vars[0][name]=new Numbr();
                        return;
                        
                        case "NUMBAR":
                        global.vars[0][name]=new Numbar();
                        return;
                        
                        case "YARN":
                        global.vars[0][name]=new Yarn();
                        return;
                        
                        case "BUKKIT":
                        global.vars[0][name]=new Bukkit();
                        return;
                    ...
                    //console.log(Troof)
                    global.vars[0][name]=new Noob()// global[types(tokens[4]||"")];
                    return;
                }
                global.vars[name] = new Noob();
            }
    ...
    function evalExpr(explicite = false) {
        ...
        if(tokens[t] in global.vars[0]) {
            return global.vars[0][tokens[t]];
        }
